"""Dimension-related utilities extending TM1py DimensionService behavior."""
...
@dataclass
class DimensionNamesResult:
    """Result of an extended get_all_names call."""

    names: List[str]
    """Dimension names in this page."""

    count: Optional[int]
    """Total number of dimensions (when $count=true). None if not requested."""

    skip: int
    """Number of dimensions skipped for this page."""

    top: Optional[int]
    """Maximum number of dimensions requested for this page."""
