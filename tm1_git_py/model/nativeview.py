...
def create_native_view(tm1_service: TM1Service, native_view: NativeView, source_path: Optional[str] = None) -> Response:
    cube_name, _ = _native_view_context_from_path(source_path)
...
def update_native_view(tm1_service: TM1Service, native_view: NativeView, source_path: Optional[str] = None) -> Response:
    cube_name, _ = _native_view_context_from_path(source_path)
    native_view_object = TM1py.NativeView.from_dict(
        view_as_dict=_to_tm1py_native_view_dict(native_view),
        cube_name=cube_name,
...
def delete_native_view(tm1_service: TM1Service, native_view: NativeView, source_path: Optional[str] = None) -> Response:
    cube_name, _ = _native_view_context_from_path(source_path)
