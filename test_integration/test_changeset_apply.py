...
class TestChangesetApply:
    ...
    def _restore_fixture_no_meta(self, fixture_model: Model):
        current_model = export_check_no_errors(self, self._f_no_meta_obj)
        restore_changeset = self.compare(current_model, fixture_model, filter_rules=self._f_no_meta_obj)
    ...
    def test_delete_cube_add_only_with_meta_objects(self):
        ...
        # when
        changeset = self.compare(test_model, fixture_model, mode='add_only', filter_rules=filter_rules)
        self.apply(changeset)
